...
plt.plot(N, bias_para, label = 'DR logistic', marker = 'o')
plt.plot(N,bias_right, label = 'DR right models', marker = 'o')
plt.plot(N, bias_wrong_om, label = 'DR wrong outcome model', marker = 'o')
plt.plot(N,bias_wrong_ps, label =  'DR wrong propensity score', marker = 'o')
plt.legend()
...
plt.plot(N,np.mean(CI[0,:,:], axis = 0), label = 'DR logistic', marker = 'o')
plt.plot(N,np.mean(CI[1,:,:], axis = 0), label = 'DR right', marker = 'o')
...
plt.figure(figsize = (10,6.6))
plt.plot(N, ratio_para, label = 'DR logistic', marker = 'o')
plt.plot(N, ratio_r, label = 'DR right', marker = 'o')
plt.plot(N, ratio_wrong_om, label = 'DR wrong outcome model', marker = 'o')
plt.plot(N, ratio_wrong_ps, label = 'DR wrong propensity score', marker = 'o')
plt.legend()
...
plt.figure(figsize = (10,6.6))
plt.plot(N, np.multiply(np.sqrt(N),bias_para), label = 'DR logistic', marker = 'o')
plt.plot(N,np.multiply(np.sqrt(N),bias_right), label = 'DR right models', marker = 'o')
plt.plot(N, np.multiply(np.sqrt(N),bias_wrong_om), label = 'DR wrong outcome model', marker = 'o')
plt.plot(N,np.multiply(np.sqrt(N),bias_wrong_ps), label =  'DR wrong propensity score', marker = 'o')
plt.legend()
plt.hlines(0, 200, 2000, linestyles = 'dashed')
plt.xlabel('Sample size', fontsize = 15)
