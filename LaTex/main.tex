...
\textit{The author apologises for the lack of data points at sample sizes $N = 600, 800$, as they ran into computational issues for these particular sample sizes that could not be fixed in time.}
...
\begin{figure}[h!]
    ...
    \caption{MLP simulation 2 results of bias for the various DR estimator specifications}
...
\begin{figure}[h!]
    ...
    \caption{MLP simulation 2 results of $\sqrt{N}$bias for the various DR estimator specifications}
...
\begin{figure}[h!]
    ...
    \caption{MLP simulation 2 results of 95\% CIs coverage for the various DR estimator specifications}
...
\begin{figure}[h!]
    ...
    \caption{MLP simulation 2's accuracy of \citet{lunceford_davidian} SE estimation for the various DR estimator specifications}
...
\begin{figure}[h!]
    ...
    \caption{MLP simulation 2's histograms of DR estimates for sample size $N = 1200$}
...
\todo[inline]{missing sample size N = 1200}
