...
for i in range(len(N)):
    estimates[:,:,i] = np.load('estimates_RF_moreW_'+ str(N[i]) + '.npy')
    CI[:,:,i] = np.load('CI_RF_moreW_'+ str(N[i]) + '.npy')
    SEs[:,:,i] = np.load('SEs_RF_moreW_'+ str(N[i]) + '.npy')
...
plt.savefig('../figures/biasRF_moreW.png')
plt.show()
...
plt.savefig('../figures/SERF_moreW.png')
plt.show()
...
plt.savefig('../figures/sqrtnRF_moreW.png')
plt.show()
...
plt.savefig('../figures/histRF_moreW.png')
plt.show()