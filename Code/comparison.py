...
fig.suptitle('Emperial bias convergence of RF vs MLP DR estimators', fontsize = 15)
...
ax1.set_xlabel('Sample size', fontsize = 15)
ax2.set_xlabel('Sample size', fontsize = 15)
ax1.set_ylabel(r'$\sqrt{N}$bias', fontsize = 15)
ax2.set_ylabel(r'$\sqrt{N}$bias', fontsize = 15)
fig.suptitle(r'$\sqrt{N}$bias convergence of RF vs MLP DR estimators', fontsize = 15)
